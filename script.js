...
// const symboilCheck=document.querySelector("#symbols");
...
//     //or v kuch krna hai ruko aate h jaara baabbr baba se puchke
...
//     if(symboilCheck.checked)hasSym=true;
...
// //    if(symboilCheck.checked)password+=generateSymbol;
// //    if(numbersCheck.checked)password+=generateRandomNumber();

// let funcArr=[];
// if(uppercaseCheck.checked)funcArr.push(generateUpperCase());
// if(lowercaseCheck.checked)funcArr.push(generateLowerCase());
// if(symboilCheck.checked)funcArr.push(generateSymbol());
